...
const baseOutputPath =
  process.env.PLAYWRIGHT_OUTPUT_DIR || './testing/playwright/results';
...
export default defineConfig({
  ...
  reporter: [
    ...
    [
      './testing/playwright/utils/moduleSummary.ts',
      { outputFile: `${baseOutputPath}/module_report.csv` },
    ],
    // Report Portal Integration (conditionally added if REPORT_PORTAL_API_TOKEN is set)
    ...(process.env.REPORT_PORTAL_API_TOKEN
